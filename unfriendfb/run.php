...
echo console :: cyan("[ Author  : Pace Usa Offical                ]\n");
echo console :: red("[ Website : https://google.com               ]\n");
echo console :: yellow("[ Github  : https://github.com/ahmadchen  ]\n");
...
echo console :: cyan("[ Author    : Pace Usa Offical        ]\n");
echo console :: red("[ Team       :           THCA         ]\n");
echo console :: yellow("[ Github  : https://github.com/ahmadchen ]\n");
echo console :: light_purple("[ Website : google.com ]\n");
echo console :: green("[         ~FACEBOOK : https://www.facebook.com    ]\n");
echo console :: blue("[===========================================]\n\n");
