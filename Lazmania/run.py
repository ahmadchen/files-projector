...
def banner():
    ...
    print (O+'        (    /`-\'\    )    '+R+'|___ |  |  /__ |  | |  | | \| | |  | ')
    print (O+'         `--:\,m//`--\'                                               ')
    print (O+'             `--\'          '+GR+'https://github.com/ahmadchen        ')
...
def bannerbr():
    ...
    print ('    |   |  |    '+GR+'https://github.com/ahmadchen'+W)
    print ('    |   |  |    ')
    print ('    |   | /     ')
    print ('    |===|/      ')
    print ('    \'---\'       ')
...
def bannerlk_dl():
    ...
    print (W+'    ███████╗██║  ██╗███████╗ ██║    '+R+'██'+C+' ║'+W)
    print (W+'    ╚══════╝╚═╝  ╚═╝╚══════╝ ╚═╝    '+R+'██'+C+' ║  ═════════════════════════════'+R)
    print ('                                    ██'+C+' ║'+W+'   https://github.com/ahmadchen'+R)
    print ('██████████████████████████████████████'+C+' ║')
    print ('╚══════════════════════════════════════╝')
    print (W+'')
...
def bannerapk():
    ...
    print (R+'   .   .   '+C+'   ;;;;;  '+W+'      :: :  :   : :. :    ::.:  :::   ::    :  ')
    print (R+'           '+C+' ..;;;;;.. ')
    print (R+'      .    '+C+'  \':::::\' '+GR+'               https://github.com/ahmadchen')
    print (R+'           '+C+'    \':`    '+W)
    print ('')
